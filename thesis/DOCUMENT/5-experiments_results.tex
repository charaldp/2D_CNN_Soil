...
\begin{figure}[htbp]
    \begin{subfigure}{0.5\textwidth}
        \includesvg[width=1.1\linewidth]{OC}
        \caption{Caption 1}
        \label{fig:subim1}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includesvg[width=1.1\linewidth]{CEC}
        \caption{Caption 2}
        \label{fig:subim2}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includesvg[width=1.1\linewidth]{Clay}
        \caption{Caption 1}
        \label{fig:subim3}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includesvg[width=1.1\linewidth]{Sand}
        \caption{Caption 1}
        \label{fig:subim4}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includesvg[width=1.1\linewidth]{pH}
        \caption{Caption 1}
        \label{fig:subim5}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includesvg[width=1.1\linewidth]{N}
        \caption{Caption 1}
        \label{fig:subim6}
    \end{subfigure}
